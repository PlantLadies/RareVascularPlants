...
1. File List
		...
		I. The data dictionary describes the variables presented in the RareVascularPlants_1.0_06062020.csv and 		includes variable names, definitions, format, value ranges, and notes.
		...
		I. Metadata for the Rare_Vascular_Plant_Full_Integrated.csv using the 							MetadataAplicationProfile_1.0_06062020.csv
